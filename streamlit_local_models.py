...
def generate_quiz(user_topic:str, client, model, num_slides = 4, num_questions = 2):
    """
...
def main():
    ...
    with st.sidebar:
        ...
        available_models = ["qwen2.5vl:3b", "gemma3:4b"]
    ...
    if 'welcome_shown' not in st.session_state:
        ...
        st.markdown("Use the trigger words found in the sidebar on the left to let the model generate questions about the lecture and show you the corresponding slides. Also make sure to select a model that is already downloaded and stored locally.")
            ...
            with st.chat_message("assistant"):
                with st.spinner("Generating Questions ... "):
                    try:
                        ...
                        reply, images = generate_quiz(topic, client, model_name, num_slides, num_questions)
